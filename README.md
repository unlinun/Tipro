...
### 專案優化期許
- 希望未來可以寫出 clean code, 有更好的延展性與調用性
- 希望可以針對安全性更加優化，並且增加審核機制，讓員工在加入前先獲得公司的批准，以免內部資料外洩
- 在員工加入後，可依據職位給予專案授權（像是可以新增專案的權利以及瀏覽公司內部作業的權利）
- 或許可以在員工註冊前，先詢問是公司還是個人，這樣才能更有效的管理人員與公司專案
